  ...
  try {
    ...
    await new Promise((resolve, reject) => {
      ...
      command.outputOptions([
        '-vf', `subtitles='${escapedSubtitlePath}':force_style='FontName=Arial,FontSize=24,PrimaryColour=&Hffffff&,BackColour=&H80000000&,Bold=1,Outline=2,OutlineColour=&H000000&,MarginV=30,MarginL=40,MarginR=40,Alignment=2'`
      ]);
