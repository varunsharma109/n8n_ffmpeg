...
const compressVideo = (inputPath, outputPath) => {
  return new Promise((resolve, reject) => {
    const cmd = `ffmpeg -i "${inputPath}" -c:v libx264 -crf 23 -preset medium -vf "scale=w=1280:h=720:force_original_aspect_ratio=decrease" -c:a aac -b:a 128k -movflags +faststart -y "${outputPath}"`;
